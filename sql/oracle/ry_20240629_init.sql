...
insert into sys_dept
values (101, 100, '0,100', '总公司', 1, '管理员', '15888888888', 'admin@example.com', '0', '0', 'admin', sysdate, '', null);
insert into sys_dept
values (102, 100, '0,100', '分公司', 2, '管理员', '15888888888', 'admin@example.com', '0', '0', 'admin', sysdate, '', null);
insert into sys_dept
values (103, 101, '0,100,101', '研发部门', 1, '管理员', '15888888888', 'admin@example.com', '0', '0', 'admin', sysdate, '', null);
insert into sys_dept
values (104, 101, '0,100,101', '市场部门', 2, '管理员', '15888888888', 'admin@example.com', '0', '0', 'admin', sysdate, '', null);
insert into sys_dept
values (105, 101, '0,100,101', '测试部门', 3, '管理员', '15888888888', 'admin@example.com', '0', '0', 'admin', sysdate, '', null);
insert into sys_dept
values (106, 101, '0,100,101', '财务部门', 4, '管理员', '15888888888', 'admin@example.com', '0', '0', 'admin', sysdate, '', null);
insert into sys_dept
values (107, 101, '0,100,101', '运维部门', 5, '管理员', '15888888888', 'admin@example.com', '0', '0', 'admin', sysdate, '', null);
...
values ('1', '系统管理', '0', '101', 'system', null, '', '', 1, 0, 'M', '0', '0', '', 'system', 'admin', sysdate, '', null, '系统管理目录');
insert into sys_menu
values ('2', '系统监控', '0', '102', 'monitor', null, '', '', 1, 0, 'M', '0', '0', '', 'monitor', 'admin', sysdate, '', null, '系统监控目录');
insert into sys_menu
values ('3', '系统工具', '0', '103', 'tool', null, '', '', 1, 0, 'M', '0', '0', '', 'tool', 'admin', sysdate, '', null, '系统工具目录');
-- 二级菜单
insert into sys_menu
values ('100', '用户管理', '1', '1', 'user', 'system/user/index', '', '', 1, 0, 'C', '0', '0', 'system:user:list', 'user', 'admin', sysdate, '', null,
        '用户管理菜单');
insert into sys_menu
values ('101', '角色管理', '1', '2', 'role', 'system/role/index', '', '', 1, 0, 'C', '0', '0', 'system:role:list', 'peoples', 'admin', sysdate, '', null,
        '角色管理菜单');
insert into sys_menu
...
values ('113', '缓存监控', '2', '5', 'cache', 'monitor/cache/index', '', '', 1, 0, 'C', '0', '0', 'monitor:cache:list', 'redis', 'admin', sysdate, '',
        null, '缓存监控菜单');
insert into sys_menu
values ('114', '缓存列表', '2', '6', 'cacheList', 'monitor/cache/list', '', '', 1, 0, 'C', '0', '0', 'monitor:cache:list', 'redis-list', 'admin', sysdate,
        '', null, '缓存列表菜单');
insert into sys_menu
...
-- 三级菜单
insert into sys_menu
values ('500', '操作日志', '108', '1', 'operlog', 'monitor/operlog/index', '', '', 1, 0, 'C', '0', '0', 'monitor:operlog:list', 'form', 'admin', sysdate,
        '', null, '操作日志菜单');
insert into sys_menu
