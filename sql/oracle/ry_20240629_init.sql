...
values (100, 0, '0', '集团', 0, '管理员', '15888888888', 'admin@example.com', '0', '0', 'admin', sysdate, '', null);
insert into sys_dept
values (101, 100, '0,100', '总公司', 1, '管理员', '15888888888', 'admin@example.com', '0', '0', 'admin', sysdate, '',
        null);
insert into sys_dept
values (102, 100, '0,100', '分公司', 2, '管理员', '15888888888', 'admin@example.com', '0', '0', 'admin', sysdate, '',
        null);
insert into sys_dept
values (103, 101, '0,100,101', '研发部门', 1, '管理员', '15888888888', 'admin@example.com', '0', '0', 'admin', sysdate,
        '', null);
insert into sys_dept
values (104, 101, '0,100,101', '市场部门', 2, '管理员', '15888888888', 'admin@example.com', '0', '0', 'admin', sysdate,
        '', null);
insert into sys_dept
values (105, 101, '0,100,101', '测试部门', 3, '管理员', '15888888888', 'admin@example.com', '0', '0', 'admin', sysdate,
        '', null);
insert into sys_dept
values (106, 101, '0,100,101', '财务部门', 4, '管理员', '15888888888', 'admin@example.com', '0', '0', 'admin', sysdate,
        '', null);
insert into sys_dept
values (107, 101, '0,100,101', '运维部门', 5, '管理员', '15888888888', 'admin@example.com', '0', '0', 'admin', sysdate,
        '', null);
...
values (1, 100, 'admin', '管理员', '00', 'admin@example.com', '15888888888', '0', '',
        '$2a$10$7JB720yubVSZvUI0rEqK/.VqGOZTH.ulu33dHOiBE8ByOhJIrdAu2',
        '0', '0', '127.0.0.1', sysdate, 'admin', sysdate, '', null, '管理员');
insert into sys_user
values (2, 101, 'user', '用户', '00', 'user@example.com', '15666666666', '0', '',
        '$2a$10$7YuziDoOb/Ct0RAGrVSJjOYw1hmMZgCY8yqM57o3IIxbf.hO.7dbS', '0',
...
values ('109', '在线用户', '2', '1', 'online', 'monitor/online/index', '', '', 1, 0, 'C', '0', '0',
        'monitor:online:list', 'online', 'admin', sysdate, '',
        null, '在线用户菜单');
insert into sys_menu
...
values ('112', '服务监控', '2', '4', 'server', 'monitor/server/index', '', '', 1, 0, 'C', '0', '0',
        'monitor:server:list', 'server', 'admin', sysdate, '',
        null, '服务监控菜单');
insert into sys_menu
...
values ('114', '缓存列表', '2', '6', 'cacheList', 'monitor/cache/list', '', '', 1, 0, 'C', '0', '0',
        'monitor:cache:list', 'redis-list', 'admin', sysdate,
        '', null, '缓存列表菜单');
insert into sys_menu
